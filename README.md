# Estou Criando um portifólio profissional. #

```
Esse Projeto será feito em React, HTML, SCSS e TypeScript. Pensando futuramente, pode ser que envolva também uma refatoração para inserção e integração com BackEnd.
